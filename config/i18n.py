...
UK = {
    ...
    "max_points_prompt": "📊 *Шкала оцінювання*\n\nСкільки балів давати за *повністю правильний* тест?\n_(наприклад: 12, 20, 100)_\n\nБали за спробу перераховуються пропорційно (з точністю до десятих).",
    "max_points_invalid": "⚠️ Введіть ціле число від 1 до 1000.",
    "max_points_set": "✅ Максимум балів за тест: *{points}*",
    "max_points_edit_prompt": "📊 Поточний максимум: *{current}* балів\n\nВведіть нове значення (1–1000):",
    "max_points_updated": "✅ Шкалу оцінювання оновлено: *{points}* балів",
    ...
    "question_type_prompt": "📝 Оберіть тип питання:",
    "question_type_single": "🔘 Одиночний вибір",
    "question_type_multiple": "✅ Множинний вибір",
    "question_type_open": "✏️ Відкрита відповідь",
    "question_type_single_selected": "🔘 Обрано: *Одиночний вибір*",
    "question_type_multiple_selected": "✅ Обрано: *Множинний вибір*",
    "question_type_open_selected": "✏️ Обрано: *Відкрита відповідь*",
    "open_answer_prompt": "➕ Еталонна відповідь {num} (для автоперевірки):",
    "open_answer_prompt_or_done": "➕ Еталонна відповідь {num} (або «Готово», якщо достатньо):",
    "accepted_answers_list": "📋 Еталонні відповіді:\n{options}",
    "min_accepted_answers": "⚠️ Потрібна щонайменше одна еталонна відповідь!",
    "question_saved_open": "✅ *Питання {num} збережено!*\nЕталонні відповіді: _{correct}_\n\nЩо далі?",
    "open_answer_add_button": "➕ Додати еталонну відповідь",
    "open_answer_add_during_edit": "➕ Надішліть текст нової *еталонної відповіді*:",
    "open_answer_edit_during_edit": "✏️ Поточна еталонна відповідь:\n\n*{text}*\n\nНадішліть новий текст:",
    "accepted_answer_updated": "✅ Еталонну відповідь оновлено.",
    "accepted_answer_added": "✅ Еталонну відповідь додано.",
    "accepted_answer_deleted": "✅ Еталонну відповідь видалено.",
    "open_answer_max_reached": "⚠️ Досягнуто максимум ({max}) еталонних відповідей.",
    ...
    "mark_multiple_correct": "🎯 Оберіть *правильні відповіді* (можна декілька), потім натисніть «Готово»:",
    "multiple_correct_done": "✓ Готово",
    "options_max_reached_multiple": "📋 Варіанти:\n{options}\n\n*Максимум варіантів досягнуто.*\n{instruction}",
    "select_at_least_one": "⚠️ Оберіть хоча б одну правильну відповідь!",
    "cannot_unmark_last_correct": "⚠️ Має залишатися принаймні одна правильна відповідь.",
    "question_saved_multiple": "✅ *Питання {num} збережено!*\nПравильні відповіді: _{correct}_\n\nЩо далі?",
    ...
    "results_student_title": "📈 *Мої результати*",
    "results_student_overview": "{bar} *{avg}*\n{count} спроб · {subjects} предм.",
    "results_student_pick_subject": "Оберіть предмет:",
    "results_student_subject_title": "📈 *{name}*",
    "results_student_subject_result": "{bar} *{avg}*\n{attempts} спроб · {tests} тестів",
    "results_student_tests_header": "Тести:",
    "results_student_line": "• *{title}* — {pct}% ({score}/{total}) · _{date}_",
    "results_student_test_title": "📈 *{title}*",
    "results_student_test_best": "Найкращий результат: *{pct}%* ({score}/{total})",
    "results_student_attempts_header": "Спроби:",
    "results_student_attempt_line": "• {pct}% ({score}/{total}) · _{date}_",
    "results_student_more": "_…ще {count}_",
    ...
    "wrong_answer_multiple": "❌ *Неправильно.*\nПравильні відповіді: _{correct}_",
    "partial_correct": "⚠️ *Частково правильно!*\nБал: {score}%",
    "answer_hidden": "❌ *Неправильно!*",
    "answer_saved": "✅ Відповідь збережено",
    "open_answer_instruction": "\n\n✏️ *Надішліть текстову відповідь повідомленням*",
    "open_answer_empty": "⚠️ Відповідь не може бути порожньою.",
    "wrong_answer_open": "❌ *Неправильно.*\nМожливі відповіді: _{correct}_",
    "use_buttons_not_text": "⚠️ Оберіть варіант кнопкою нижче.",
    ...
    "stats_empty": "Поки немає активних тестів.",
    "stats_overview": "{bar} *{avg}*\n{sessions} прох. · {tests} тестів · {subjects} предм.",
    "stats_overview_pending": "{tests} тестів · {subjects} предм.\nЩе немає проходжень.",
    "stats_pick_subject": "Оберіть предмет:",
    "stats_subject_title": "📊 *{name}*",
    "stats_subject_result": "{bar} *{avg}*\n{sessions} прох. · {tests} тестів",
    "stats_subject_pending": "Поки немає проходжень.\n{tests} тестів очікують результатів.",
    "stats_results_header": "👥 *Хто проходив:*",
    "stats_student": "• *{name}* — {pct}% ({score}/{total})",
    "stats_student_test": "• *{name}* — {pct}% ({score}/{total}) · _{test}_",
    "stats_results_more": "_…ще {count} (оберіть тест нижче)_",
    "stats_pick_test": "Оберіть тест:",
    "stats_test_title": "📊 *{title}*",
    "stats_test_empty": "Ще ніхто не проходив цей тест.",
    ...
    "option_empty": "⚠️ Варіант не може бути порожнім:",
    "min_options": "⚠️ Потрібно щонайменше 2 варіанти!",
    "cannot_delete_correct_option": "⚠️ Не можна видалити правильну відповідь. Спочатку оберіть іншу.",
    "cannot_delete_last_question": "⚠️ Не можна видалити останнє питання. У тесті має залишатися принаймні одне.",
...
EN = {
    ...
    "max_points_prompt": "📊 *Grading scale*\n\nHow many points for a *fully correct* test?\n_(e.g. 12, 20, 100)_\n\nAttempt scores are scaled proportionally (to one decimal).",
    "max_points_invalid": "⚠️ Enter a whole number from 1 to 1000.",
    "max_points_set": "✅ Maximum points for the test: *{points}*",
    "max_points_edit_prompt": "📊 Current maximum: *{current}* points\n\nEnter a new value (1–1000):",
    "max_points_updated": "✅ Grading scale updated: *{points}* points",
    ...
    "question_type_prompt": "📝 Select question type:",
    "question_type_single": "🔘 Single choice",
    "question_type_multiple": "✅ Multiple choice",
    "question_type_open": "✏️ Open answer",
    "question_type_single_selected": "🔘 Selected: *Single choice*",
    "question_type_multiple_selected": "✅ Selected: *Multiple choice*",
    "question_type_open_selected": "✏️ Selected: *Open answer*",
    "open_answer_prompt": "➕ Reference answer {num} (for auto-check):",
    "open_answer_prompt_or_done": "➕ Reference answer {num} (or tap Done if enough):",
    "accepted_answers_list": "📋 Reference answers:\n{options}",
    "min_accepted_answers": "⚠️ At least one reference answer is required!",
    "question_saved_open": "✅ *Question {num} saved!*\nReference answers: _{correct}_\n\nWhat next?",
    "open_answer_add_button": "➕ Add reference answer",
    "open_answer_add_during_edit": "➕ Send the text of a new *reference answer*:",
    "open_answer_edit_during_edit": "✏️ Current reference answer:\n\n*{text}*\n\nSend new text:",
    "accepted_answer_updated": "✅ Reference answer updated.",
    "accepted_answer_added": "✅ Reference answer added.",
    "accepted_answer_deleted": "✅ Reference answer deleted.",
    "open_answer_max_reached": "⚠️ Maximum of {max} reference answers reached.",
    ...
    "mark_multiple_correct": "🎯 Select *correct answers* (multiple allowed), then tap Done:",
    "multiple_correct_done": "✓ Done",
    "options_max_reached_multiple": "📋 Options:\n{options}\n\n*Maximum options reached.*\n{instruction}",
    "select_at_least_one": "⚠️ Select at least one correct answer!",
    "cannot_unmark_last_correct": "⚠️ At least one correct answer must remain.",
    "question_saved_multiple": "✅ *Question {num} saved!*\nCorrect answers: _{correct}_\n\nWhat next?",
    ...
    "results_student_title": "📈 *My Results*",
    "results_student_overview": "{bar} *{avg}*\n{count} attempts · {subjects} subjects",
    "results_student_pick_subject": "Select a subject:",
    "results_student_subject_title": "📈 *{name}*",
    "results_student_subject_result": "{bar} *{avg}*\n{attempts} attempts · {tests} tests",
    "results_student_tests_header": "Tests:",
    "results_student_line": "• *{title}* — {pct}% ({score}/{total}) · _{date}_",
    "results_student_test_title": "📈 *{title}*",
    "results_student_test_best": "Best result: *{pct}%* ({score}/{total})",
    "results_student_attempts_header": "Attempts:",
    "results_student_attempt_line": "• {pct}% ({score}/{total}) · _{date}_",
    "results_student_more": "_…{count} more_",
    ...
    "wrong_answer": "❌ *Wrong.*\nCorrect answer: _{correct}_",
    "wrong_answer_multiple": "❌ *Wrong.*\nCorrect answers: _{correct}_",
    "partial_correct": "⚠️ *Partially correct!*\nScore: {score}%",
    "answer_hidden": "❌ *Wrong!*",
    "answer_saved": "✅ Answer saved",
    "open_answer_instruction": "\n\n✏️ *Send your answer as a text message*",
    "open_answer_empty": "⚠️ Answer cannot be empty.",
    "wrong_answer_open": "❌ *Wrong.*\nAccepted answers: _{correct}_",
    "use_buttons_not_text": "⚠️ Please select an option using the buttons below.",
    ...
    "stats_empty": "No active tests yet.",
    "stats_overview": "{bar} *{avg}*\n{sessions} attempts · {tests} tests · {subjects} subjects",
    "stats_overview_pending": "{tests} tests · {subjects} subjects\nNo attempts yet.",
    "stats_pick_subject": "Select a subject:",
    "stats_subject_title": "📊 *{name}*",
    "stats_subject_result": "{bar} *{avg}*\n{sessions} attempts · {tests} tests",
    "stats_subject_pending": "No attempts yet.\n{tests} tests awaiting results.",
    "stats_results_header": "👥 *Who took the test:*",
    "stats_student": "• *{name}* — {pct}% ({score}/{total})",
    "stats_student_test": "• *{name}* — {pct}% ({score}/{total}) · _{test}_",
    "stats_results_more": "_…{count} more (pick a test below)_",
    "stats_pick_test": "Select a test:",
    "stats_test_title": "📊 *{title}*",
    "stats_test_empty": "No one has taken this test yet.",
    ...
    "option_empty": "⚠️ Option cannot be empty:",
    "min_options": "⚠️ Need at least 2 options!",
    "cannot_delete_correct_option": "⚠️ Cannot delete the correct answer. Select another one first.",
    "cannot_delete_last_question": "⚠️ Cannot delete the last question. A test must have at least one question.",
