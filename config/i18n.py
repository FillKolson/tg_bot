...
UK = {
    ...
    "open_answer_prompt_or_done": "➕ Еталонна відповідь {num} (або натисніть кнопку «Завершити введення»):",
    ...
    "option_prompt_or_done": "➕ Введіть варіант {num} (або натисніть кнопку нижче, якщо варіантів достатньо):",
    "done_options": "✅ Додати варіанти та обрати правильний",
    "done_options_open": "✅ Завершити введення",
    ...
    "demo_test_intro": "🧪 *Демонстраційний запуск тесту*\n\n📝 *{title}*\n❓ Питань: *{count}*\n\nВідповіді не зберігаються — це лише для перевірки.",
    "demo_test_finished": "🏁 *Тестування завершено!*\n\n📝 *{title}*\n📊 Результат: *{score} / {total}* ({pct}%)\n\nℹ️ Це демонстраційний запуск — результати не зберігаються.",
    ...
    "stats_period_label": "Фільтр: {period}",
    "stats_subject_title": "📊 *{name}*",
    "stats_period_all": "Весь час",
    "stats_period_week": "7 днів",
    "stats_period_month": "30 днів",
...
EN = {
    ...
    "open_answer_prompt_or_done": "➕ Reference answer {num} (or tap the “Finish entering” button):",
    ...
    "option_prompt_or_done": "➕ Enter option {num} (or tap the button below if enough):",
    "done_options": "✅ Add options and select the correct one",
    "done_options_open": "✅ Finish entering",
    ...
    "demo_test_intro": "🧪 *Demo test run*\n\n📝 *{title}*\n❓ Questions: *{count}*\n\nAnswers are not saved — this is only for checking.",
    "demo_test_finished": "🏁 *Test run completed!*\n\n📝 *{title}*\n📊 Result: *{score} / {total}* ({pct}%)\n\nℹ️ This is a demo run — results are not saved.",
    ...
    "stats_period_label": "Filter: {period}",
    "stats_subject_title": "📊 *{name}*",
    "stats_period_all": "All time",
    "stats_period_week": "7 days",
    "stats_period_month": "30 days",
