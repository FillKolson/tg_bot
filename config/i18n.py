...
UK = {
    ...
    "teacher_tip": "Натисніть *➕ Створити тест*, щоб розпочати роботу.\nВведіть /help для перегляду можливостей.",
        "enter_teacher_code": "🔑 Введіть код вчителя для підтвердження доступу:\n\n_/cancel — скасувати_",
        "teacher_code_invalid": "❌ Невірний код. Якщо у вас немає коду, зверніться до адміністратора:",
        "teacher_code_accepted": "✅ Код прийнято. Тепер введіть ваше повне ім'я:",
        "enter_teacher_password_prompt": "🔒 Придумайте пароль доступу для вчителя (мін. 8 символів):",
        "password_too_short": "⚠️ Пароль занадто короткий (мінімум 8 символів).",
    ...
    "profile_reset_password": "🔑 Скинути пароль ( за кодом )",
    "enter_current_password": "🔐 Введіть поточний пароль:",
    "enter_new_password_prompt": "🔐 Введіть новий пароль (мін. 8 символів):",
    "password_incorrect": "❌ Невірний пароль.",
    "password_too_common": "⚠️ Пароль занадто простий або часто вживаний.",
    "password_changed": "✅ Пароль успішно змінено.",
    "password_reset_success": "✅ Пароль скинуто успішно.",
    "too_many_attempts": "⛔ Занадто багато невдалих спроб. Обліковку заблоковано на 30 хв.",
    "account_locked": "⛔ Обліковку заблоковано до {until}",
    "password_incorrect": "❌ Невірний пароль.",
...
EN = {
    ...
    "teacher_tip": "Click *➕ Create Test* to start.\nType /help for features.",
        "enter_teacher_code": "🔑 Enter teacher code to confirm access:\n\n_/cancel — cancel_",
        "teacher_code_invalid": "❌ Invalid code. If you don't have it, contact the admin:",
        "teacher_code_accepted": "✅ Code accepted. Now enter your full name:",
        "enter_teacher_password_prompt": "🔒 Choose a password for teacher access (min 8 chars):",
        "password_too_short": "⚠️ Password too short (minimum 8 characters).",
    ...
    "profile_reset_password": "🔑 Reset Password (by code)",
    "enter_current_password": "🔐 Enter current password:",
    "enter_new_password_prompt": "🔐 Enter new password (min 8 chars):",
    "password_incorrect": "❌ Incorrect password.",
    "password_too_common": "⚠️ Password is too common or weak.",
    "password_changed": "✅ Password changed successfully.",
    "password_reset_success": "✅ Password reset successfully.",
    "too_many_attempts": "⛔ Too many failed attempts. Account locked for 30 minutes.",
