...
UK = {
    ...
    # Teacher: Create test     "create_test_wizard": "📝 *Майстер створення тесту*\n\n*Крок 1/5* — Введіть назву тесту:\n\n_/cancel — скасувати_",
    ...
    # Question creation     "question_too_short": "⚠️ Текст питання занадто короткий:",
    ...
    # Results    "results_menu": "📊 *Оберіть тест для перегляду результатів:*",
    ...
    # Student: Browse     "no_public_tests": "😔 Публічних предметів ще немає.\nСпробуйте ввести код приватного тесту через 🔑.",
    ...
    # Private test    "enter_code_prompt": "🔑 Введіть код доступу до приватного тесту:\n\n_/cancel — скасувати_",
    ...
    # Taking test    "test_no_questions": "⚠️ У цьому тесті немає питань.",
    ...
    # Menu items    "menu_create_test": "➕ Створити тест",
    ...
    # Errors    "teacher_only": "⛔ Ця функція доступна лише для вчителів.",
...
EN = {
    # Auth    "welcome": "👋 *Welcome to the Quiz Bot!*\n\nPlease select your role:",
    ...
    # Teacher: Create test     "create_test_wizard": "📝 *Test Creation Wizard*\n\n*Step 1/5* — Enter test name:\n\n_/cancel — cancel_",
    ...
    # Question creation     "question_too_short": "⚠️ Question text too short:",
    ...
    # Results    "results_menu": "📊 *Select test to view results:*",
    ...
    # Student: Browse     "no_public_tests": "😔 No public subjects yet.\nTry entering a private test code via 🔑.",
    ...
    # Private test    "enter_code_prompt": "🔑 Enter private test access code:\n\n_/cancel — cancel_",
    ...
    # Taking test    "test_no_questions": "⚠️ This test has no questions.",
    ...
    # Menu items    "menu_create_test": "➕ Create Test",
    ...
    # Errors    "teacher_only": "⛔ This feature is only for teachers.",
